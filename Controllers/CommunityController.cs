...
namespace Reddit.Controllers
{
    ...
    public class CommunityController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<PagedList<Community>>> GetCommunities(string? sortTearm, bool? isAscending, int page = 1, int pageSize = 2, string? searchTerm = null)
        {
            if (pageSize > 50) throw new Exception();

            return await _communitiesRepository.GetCommunities(page, pageSize, searchTerm, sortTearm, isAscending);
        }
